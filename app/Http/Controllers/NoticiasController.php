...
class NoticiasController extends Controller
{
    ...
    public function update($id, Request $request){
        ...
        if ($noticia) {
            ...
            if ($noticia->save()){
                return redirect()->route('noticias.edit', $noticia->id)->with('exito', 'Se actualizó correctamente');
            }
            return redirect()->route('noticia.edit', $noticia->id)->with('error', 'No se pudo actualizar');
        }
    ...
    public function destroy($id){
        ...
        return redirect()->route('noticias.index')->with('error','No se encontró noticia a borrar');
    }
}
